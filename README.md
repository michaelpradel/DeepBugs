...
`python3 python/BugLearnAndValidate.py SwappedArgs token_to_vector.json type_to_vector.json node_type_to_vector.json --trainingData calls_xx*.json --validationData calls_yy*.json`
